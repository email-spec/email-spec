module EmailSpec
  class EmailViewer
    ...
    class << self
      def save_and_open_all_raw_emails
      ...
      def save_and_open_all_html_emails
      ...
      def save_and_open_all_text_emails
        filename = tmp_email_filename
      ...
      def save_and_open_email_attachments_list(mail)
        filename = tmp_email_filename
      ...
      def open_in_text_editor(filename)
